...
export default function TeacherSignupPage() {
  return (
    <div className="grid h-svh overflow-hidden lg:grid-cols-[60%_40%]">
      <div className="relative hidden h-svh bg-muted lg:block">
        <div className="relative h-dvh w-full overflow-hidden bg-blue-700">
          <div
      ...
      <div className="flex h-full flex-col gap-4 overflow-y-auto bg-[#FAF9F6] p-6 scrollbar-hide md:p-10">
