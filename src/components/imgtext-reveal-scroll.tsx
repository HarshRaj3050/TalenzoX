...
export const ImageTextReveal: React.FC<ImageTextRevealProps> = ({
  ...
  const defaultTextClass =
    'text-[clamp(2.2rem,7.5vw,7.5rem)] font-black tracking-tighter leading-none whitespace-nowrap uppercase select-none text-zinc-900';
