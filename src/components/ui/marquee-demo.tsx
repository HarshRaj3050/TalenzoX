...
const ReviewCard = ({
  ...
  return (
    <figure
      className={cn(
        "relative h-full w-60 cursor-pointer overflow-hidden rounded-xl border px-3 py-2 text-black",
        // light styles
        "bg-linear-to-br from-gray-100/50 via-white/60 to-blue-200 border border-white",
      )}
    >
